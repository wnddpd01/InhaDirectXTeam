...
void cRightArm::Setup()
{
	...
	//:left
	m_vecVertex[12].t = D3DXVECTOR2(0, 0.5f);
	m_vecVertex[13].t = D3DXVECTOR2(0, 0.4f);
	m_vecVertex[14].t = D3DXVECTOR2(0, 0.4f);
	m_vecVertex[15].t = D3DXVECTOR2(0, 0.5f);
	m_vecVertex[16].t = D3DXVECTOR2(0, 0.5f);
	m_vecVertex[17].t = D3DXVECTOR2(0, 0.4f);

	//:right

	m_vecVertex[18].t = D3DXVECTOR2(0.1f, 0.5f);
	m_vecVertex[19].t = D3DXVECTOR2(0, 0.4f);
	m_vecVertex[20].t = D3DXVECTOR2(0, 0.4f);
	m_vecVertex[21].t = D3DXVECTOR2(0.1f, 0.5f);
	m_vecVertex[22].t = D3DXVECTOR2(0.1f, 0.5f);
	m_vecVertex[23].t = D3DXVECTOR2(0, 0.4f);
	...
	m_vLocalPos.y = 0.3f; //전체적인 위치 다시 조정
}
