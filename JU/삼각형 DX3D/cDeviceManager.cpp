	...
	, m_pD3DDevice(NULL)
{
	...
	{
		nVertexProcessing = D3DCREATE_HARDWARE_VERTEXPROCESSING; // GPU
	}
	else
	{
	...
	FAILED(m_pD3D->CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, g_hWnd, nVertexProcessing, &stD3DPP, &m_pD3DDevice));
