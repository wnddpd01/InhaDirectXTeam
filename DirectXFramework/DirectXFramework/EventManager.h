...
{
	SCENE_CHANGE = 0, MOUSE_L_DOWN, MOUSE_R_DOWN, MOUSE_L_UP, MOUSE_R_UP, MOUSE_L_DRAG, MOUSE_R_DRAG, MOUSE_WHEEL_DOWN, MOUSE_WHEEL_SCROLL, MOUSE_MOVE, KEY_DOWN, KEY_UP
};
