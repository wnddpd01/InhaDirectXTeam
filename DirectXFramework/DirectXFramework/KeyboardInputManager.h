...
enum class eKeyName
{
	KEY_LEFT_DOWN = 0, KEY_RIGHT_DOWN, KEY_FRONT_DOWN, KEY_BACK_DOWN, KEY_FRONTLEFT_DOWN, KEY_FRONTRIGHT_DOWN,
	KEY_BACKLEFT_DOWN, KEY_BACKRIGHT_DOWN, KEY_INTERACTION_DOWN,KEY_EQUIPCHAGELFFT_DOWN, KEY_EQUIPCHAGERIGHT_DOWN , KEY_RUN_DOWN
};
