...
void cBody::Setup()
{
	...
	//앞
	float left, top;
	left = 16.f / TEXTURESIZE;
	top = 16.f / TEXTURESIZE;

	float width = 8.f / TEXTURESIZE;
	...
	//아래
	m_vecVertex[30].t.x = left + deep + width;  m_vecVertex[30].t.y = top;
	m_vecVertex[31].t.x = left + deep + width;  m_vecVertex[31].t.y = top + deep;
	m_vecVertex[32].t.x = left + 2*deep + width;  m_vecVertex[32].t.y = top + deep;

	m_vecVertex[33].t.x = left + deep + width;  m_vecVertex[33].t.y = top;
	m_vecVertex[34].t.x = left + 2 * deep + width;  m_vecVertex[34].t.y = top + deep;
	m_vecVertex[35].t.x = left + 2 * deep + width;  m_vecVertex[35].t.y = top;
