...
void cLeftArm::Setup()
{
	...
	m_vecVertex[6].t = { armStartX, armStartY };
	m_vecVertex[8].t = { armStartX, armStartY - 3.0f / 8.0f, };
	m_vecVertex[7].t = { armStartX + 1.0f / 16.0f, armStartY - 3.0f / 8.0f };
	m_vecVertex[9].t = { armStartX, armStartY };
	m_vecVertex[11].t = m_vecVertex[7].t;
	m_vecVertex[10].t = { armStartX + 1.0f / 16.0f, armStartY };
	armStartX += 1.0f / 16.0f;
	...
	m_vecVertex[18].t = { armStartX + 1.0f / 16.0f, armStartY };
	m_vecVertex[20].t = { armStartX , armStartY - 3.0f / 8.0f };
	m_vecVertex[19].t = { armStartX + 1.0f / 16.0f , armStartY - 3.0f / 8.0f };
	m_vecVertex[23].t = { armStartX, armStartY };
	m_vecVertex[22].t = { armStartX , armStartY - 3.0f / 8.0f };
	m_vecVertex[21].t = { armStartX + 1.0f / 16.0f , armStartY};
