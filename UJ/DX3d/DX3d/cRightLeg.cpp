...
void cRightLeg::Setup()
{
	...
	m_vecVertex[6].t = { legStartX + 1.0f / 16.0f,  legStartY};
	m_vecVertex[7].t = { legStartX , legStartY - 3.0f / 8.0f };
	m_vecVertex[8].t = { legStartX + 1.0f / 16.0f, legStartY - 3.0f / 8.0f };
	m_vecVertex[9].t = { legStartX + 1.0f / 16.0f, legStartY };
	m_vecVertex[10].t = { legStartX, legStartY };
	m_vecVertex[11].t = { legStartX, legStartY - 3.0f / 8.0f, };
	legStartX += 1.0f / 16.0f;
	...
	m_vecVertex[18].t = { legStartX, legStartY };
	m_vecVertex[19].t = { legStartX, legStartY - 3.0f / 8.0f, };
	m_vecVertex[20].t = { legStartX + 1.0f / 16.0f, legStartY - 3.0f / 8.0f };
	m_vecVertex[21].t = { legStartX, legStartY };
	m_vecVertex[22].t = m_vecVertex[20].t;
	m_vecVertex[23].t = { legStartX + 1.0f / 16.0f, legStartY };
