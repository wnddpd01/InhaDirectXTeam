...
public:
	...
	static cMatrix RotationX(float angle, bool isRadian = false);
	static cMatrix RotationY(float angle, bool isRadian = false);
	static cMatrix RotationZ(float angle, bool isRadian = false);
