...
cMatrix cMatrix::RotationX(float angle, bool isRadian)
{
	cMatrix cMat(4);
	cMat = cMat.Identity(cMat.dimension);
...
cMatrix cMatrix::RotationY(float angle, bool isRadian)
{
	cMatrix cMat(4);
	cMat = cMat.Identity(cMat.dimension);
...
cMatrix cMatrix::RotationZ(float angle, bool isRadian)
{
	cMatrix cMat(4);
	cMat = cMat.Identity(cMat.dimension);
